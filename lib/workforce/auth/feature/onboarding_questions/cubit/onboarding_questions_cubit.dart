...
part 'onboarding_questions_state.dart';

class OnboardingQuestionsCubit extends Cubit<OnboardingQuestionsState>
    with Validator {
  ...
  OnboardingQuestionsCubit(this._bffRemoteRepository)
      : super(OnboardingQuestionsInitial());
