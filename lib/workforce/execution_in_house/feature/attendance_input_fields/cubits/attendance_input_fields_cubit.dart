...
part 'attendance_input_fields_state.dart';

class AttendanceInputFieldsCubit extends Cubit<AttendanceInputFieldsState> {
  ...
  final buttonStatus = BehaviorSubject<ButtonStatus>.seeded(ButtonStatus(isEnable: false));
  Function(ButtonStatus) get changeButtonStatus => buttonStatus.sink.add;
  AttendanceInputFieldsCubit() : super(AttendanceInputFieldsInitial());
