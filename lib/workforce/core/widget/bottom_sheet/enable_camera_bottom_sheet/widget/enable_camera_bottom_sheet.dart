...
void showEnableCameraBottomSheet(BuildContext context,Function() onOpenTap,Function() onCancelTap) {
  showModalBottomSheet(
    ...
    builder: (_) {
      return  EnableCameraBottomSheet(onOpenTap,onCancelTap);
    },
  );
}

class EnableCameraBottomSheet extends StatelessWidget {
  final Function() onOpenTap;
  final Function() onCancelTap;
  const EnableCameraBottomSheet(this.onOpenTap,this.onCancelTap,{Key? key}) : super(key: key);
  ...
  Widget buildAccessCameraText()
  {
    return Positioned(
      ...
      child: Column(
        children: [
          Text(
            'please_allow_us_to_access_your_camera'.tr,
            textAlign: TextAlign.center,
