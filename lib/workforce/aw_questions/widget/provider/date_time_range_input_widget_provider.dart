...
import 'package:awign/workforce/aw_questions/widget/date_time/date_time_range_input_array_widget.dart';
import 'package:awign/workforce/aw_questions/widget/date_time/date_time_range_input_widget.dart';
import 'package:awign/workforce/aw_questions/widget/text/default_array_input_widget.dart';
import 'package:flutter/cupertino.dart';

class DateTimeRangeInputWidgetProvider {
    ...
    switch (question.dataType) {
      case DataType.single:
        if (renderType == RenderType.ARRAY) {
          return const DateTimeRangeInputArrayWidget();
        } else {
          return DateTimeRangeInputWidget(question, onAnswerUpdate);
        }
      case DataType.array:
