...
import '../../workforce/core/data/model/ui_status.dart';
import '../../workforce/core/data/model/widget_result.dart';
...
class InAppCameraWidget extends StatefulWidget {
  ...
  InAppCameraWidget(this.imageDetails,
  ...
  @override
  _InAppCameraWidgetState createState() => _InAppCameraWidgetState();
}
  ...
  Widget buildPermissionDeniedWidget() {
    return Column(
      ...
      children: [
        ...
        const Padding(
          padding: EdgeInsets.fromLTRB(Dimens.padding_16, Dimens.padding_16, Dimens.padding_16, 0),
          child: Text(
            'This app uses the camera to capture photos and images for work-related tasks and document scanning as needed by Awign projects',
            textAlign: TextAlign.center,
            style: TextStyle(
              color: Colors.white,
              fontSize: 16,
        ...
        onTap: _isVideoCameraSelected
            ...
            : () async {
                ...
                LoggingData loggingData = LoggingData(
                    event: LoggingEvents.captureClickedCamera,
                    action: LoggingActions.clicked,pageName: LoggingPageNames.capture);
