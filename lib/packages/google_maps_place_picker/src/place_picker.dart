...
import 'package:awign/packages/google_maps_place_picker/src/google_map_place_picker.dart';
import 'package:awign/packages/google_maps_place_picker/src/models/pick_result.dart';
import 'package:awign/packages/google_maps_place_picker/src/utils/uuid.dart';
...
class _PlacePickerState extends State<PlacePicker> {
    ...
    return WillPopScope(
      ...
      child: FutureBuilder<PlaceProvider>(
        ...
        builder: (context, snapshot) {
              ...
              child: widget.onScreenAutocomplete
                  ...
                  : Scaffold(
                      ...
                      appBar: AppBar(
                        ...
                        titleSpacing: 0.0,
                        title: widget.isSearchBarVisible
                            ? _buildSearchBar(context)
                            : const SizedBox(),
                      ),
          ...
          return Scaffold(
            body: widget.onScreenAutocomplete
                ? const SizedBox()
                : Center(
                    child: Column(
      ...
      children: <Widget>[
        Expanded(
          child: AutoCompleteSearch(
              onScreenTextEditingController:
                  widget.onScreenTextEditingController,
              errorText: widget.errorText,
              onScreenAutocomplete: widget.onScreenAutocomplete,
              appBarKey: appBarKey,
  ...
  _pickPrediction(Prediction prediction) async {
    ...
    if (widget.onScreenAutocomplete && widget.onPlacePicked != null) {
      ...
      return FutureBuilder(
          ...
          builder: (context, snap) {
            if (snap.connectionState == ConnectionState.waiting) {
              ...
              } else if(provider?.selectedPlace?.geometry?.location.lat != null
              && provider?.selectedPlace?.geometry?.location.lng != null) {
                return _buildMap(LatLng(provider!.selectedPlace!.geometry!.location.lat,
                    provider!.selectedPlace!.geometry!.location.lng));
              } else {
