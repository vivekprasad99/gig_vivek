...
import 'package:awign/packages/flutter_image_editor/extension/num_extension.dart';
import 'package:awign/packages/flutter_image_editor/model/float_text_model.dart';
...
class TextEditorPageState extends State<TextEditorPage>
  ...
  static TextConfigModel get configModel =>
      ImageEditorWidget.uiDelegate.textConfigModel;
  ...
  final List<Color> textColorList = ImageEditorWidget.uiDelegate.textColors;
  ...
  FloatTextModel buildModel() {
    ...
    return FloatTextModel(
        ...
        top: offset.dy,
        left: offset.dx,
        style: TextStyle(fontSize: _size, color: _textColor));
  }
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        GestureDetector(
                          onTap: tapBoldBtn,
                          child: ImageEditorWidget.uiDelegate.boldTagWidget,
                        ),
                        24.hGap,
                        ImageEditorWidget.uiDelegate.sliderLeftWidget,
                        8.hGap,
                        Expanded(child: _buildSlider()),
                        8.hGap,
                        ImageEditorWidget.uiDelegate.sliderRightWidget,
                        2.hGap,
                      ],
                    ),
                  ),
  ...
  Widget _buildSlider() {
    return SliderTheme(
        data: ImageEditorWidget.uiDelegate.sliderThemeData(context),
        child: Slider(
          value: _size,
