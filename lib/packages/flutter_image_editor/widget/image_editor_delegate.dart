import 'package:awign/packages/flutter_image_editor/widget/float_text_widget.dart';
...
class DefaultImageEditorWidgetDelegate extends ImageEditorWidgetDelegate{
  ...
  Widget backBtnWidget(double limitSize) {
    return Icon(Icons.arrow_back, color: AppColors.backgroundWhite, size: limitSize);
  }
...
abstract class ImageEditorWidgetDelegate{
